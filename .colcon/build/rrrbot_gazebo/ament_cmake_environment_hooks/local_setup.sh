...
: ${AMENT_CURRENT_PREFIX:="/overlay_ws/install/rrrbot_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rrrbot_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rrrbot_gazebo/environment/path.sh"
