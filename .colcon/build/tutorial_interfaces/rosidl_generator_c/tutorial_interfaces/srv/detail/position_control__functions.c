...
tutorial_interfaces__srv__PositionControl_Request__are_equal(const tutorial_interfaces__srv__PositionControl_Request * lhs, const tutorial_interfaces__srv__PositionControl_Request * rhs)
{
  ...
  // joint1_ref
  if (lhs->joint1_ref != rhs->joint1_ref) {
    return false;
  }
  // joint2_ref
  if (lhs->joint2_ref != rhs->joint2_ref) {
    return false;
  }
  // joint3_ref
  if (lhs->joint3_ref != rhs->joint3_ref) {
    return false;
  }
  return true;
}
  ...
  tutorial_interfaces__srv__PositionControl_Request * output)
{
  ...
  // joint1_ref
  output->joint1_ref = input->joint1_ref;
  // joint2_ref
  output->joint2_ref = input->joint2_ref;
  // joint3_ref
  output->joint3_ref = input->joint3_ref;
  return true;
}
...
tutorial_interfaces__srv__PositionControl_Request__create()
{
  ...
  tutorial_interfaces__srv__PositionControl_Request * msg = (tutorial_interfaces__srv__PositionControl_Request *)allocator.allocate(sizeof(tutorial_interfaces__srv__PositionControl_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__srv__PositionControl_Request));
  bool success = tutorial_interfaces__srv__PositionControl_Request__init(msg);
  if (!success) {
...
tutorial_interfaces__srv__PositionControl_Request__destroy(tutorial_interfaces__srv__PositionControl_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tutorial_interfaces__srv__PositionControl_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tutorial_interfaces__srv__PositionControl_Request__Sequence__init(tutorial_interfaces__srv__PositionControl_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__PositionControl_Request * data = NULL;

  if (size) {
    data = (tutorial_interfaces__srv__PositionControl_Request *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__srv__PositionControl_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__srv__PositionControl_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutorial_interfaces__srv__PositionControl_Request__fini(&data[i - 1]);
      }
...
tutorial_interfaces__srv__PositionControl_Request__Sequence__fini(tutorial_interfaces__srv__PositionControl_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__srv__PositionControl_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__PositionControl_Request__Sequence * array = (tutorial_interfaces__srv__PositionControl_Request__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__srv__PositionControl_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__srv__PositionControl_Request__Sequence__init(array, size);
  if (!success) {
...
tutorial_interfaces__srv__PositionControl_Request__Sequence__destroy(tutorial_interfaces__srv__PositionControl_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__srv__PositionControl_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__srv__PositionControl_Request__Sequence__are_equal(const tutorial_interfaces__srv__PositionControl_Request__Sequence * lhs, const tutorial_interfaces__srv__PositionControl_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__srv__PositionControl_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__srv__PositionControl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__srv__PositionControl_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__srv__PositionControl_Request * data =
      (tutorial_interfaces__srv__PositionControl_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__PositionControl_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__PositionControl_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__srv__PositionControl_Request__copy(
...
tutorial_interfaces__srv__PositionControl_Response__are_equal(const tutorial_interfaces__srv__PositionControl_Response * lhs, const tutorial_interfaces__srv__PositionControl_Response * rhs)
{
  ...
  // theta1_des
  if (lhs->theta1_des != rhs->theta1_des) {
    return false;
  }
  // theta2_des
  if (lhs->theta2_des != rhs->theta2_des) {
    return false;
  }
  // theta3_des
  if (lhs->theta3_des != rhs->theta3_des) {
    return false;
  }
  return true;
}
  ...
  tutorial_interfaces__srv__PositionControl_Response * output)
{
  ...
  // theta1_des
  output->theta1_des = input->theta1_des;
  // theta2_des
  output->theta2_des = input->theta2_des;
  // theta3_des
  output->theta3_des = input->theta3_des;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__PositionControl_Response * msg = (tutorial_interfaces__srv__PositionControl_Response *)allocator.allocate(sizeof(tutorial_interfaces__srv__PositionControl_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__srv__PositionControl_Response));
  bool success = tutorial_interfaces__srv__PositionControl_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__PositionControl_Response__destroy(tutorial_interfaces__srv__PositionControl_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tutorial_interfaces__srv__PositionControl_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tutorial_interfaces__srv__PositionControl_Response__Sequence__init(tutorial_interfaces__srv__PositionControl_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__PositionControl_Response * data = NULL;

  if (size) {
    data = (tutorial_interfaces__srv__PositionControl_Response *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__srv__PositionControl_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__srv__PositionControl_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tutorial_interfaces__srv__PositionControl_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tutorial_interfaces__srv__PositionControl_Response__Sequence__fini(tutorial_interfaces__srv__PositionControl_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__srv__PositionControl_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__PositionControl_Response__Sequence * array = (tutorial_interfaces__srv__PositionControl_Response__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__srv__PositionControl_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__srv__PositionControl_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__PositionControl_Response__Sequence__destroy(tutorial_interfaces__srv__PositionControl_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__srv__PositionControl_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__srv__PositionControl_Response__Sequence__are_equal(const tutorial_interfaces__srv__PositionControl_Response__Sequence * lhs, const tutorial_interfaces__srv__PositionControl_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__srv__PositionControl_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__srv__PositionControl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__srv__PositionControl_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__srv__PositionControl_Response * data =
      (tutorial_interfaces__srv__PositionControl_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__PositionControl_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__PositionControl_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__srv__PositionControl_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
